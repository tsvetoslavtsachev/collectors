...
Композитно правило: 3 на ✅ от активните серии, задължително включващи С1 или С2 → тезата доказана; 3 на ❌ от {comp["active"]} активни серии → опровергана. Не е инвестиционен съвет.</footer>
</div>
</body>
</html>'''
